...
if (selected == 'Loan Prediction'):
    ...
    with col2:
        Married = st.text_input('are you married')
    
    with col3:
        Dependents = st.text_input('are you dependents')
    ...
    with col1:
        ApplicantIncome = st.text_input('how much your applicant income')
    
    with col2:
        CoapplicantIncome = st.text_input('how much your coapplicant income')
    
    with col3:
        LoanAmount = st.text_input('how much your loan amount')
        
    with col4:
        Loan_Amount_Term = st.text_input('how much your loan amount in term')
    
    with col5:
        Credit_History = st.text_input('how your credit history')
        
    with col1:
        Property_Area_Rural = st.text_input('your property area in rural?')
        
    with col2:
        Property_Area_Semiurban = st.text_input('your property area in semi urban?')
        
    with col3:
        Property_Area_Urban = st.text_input('your property area in urban?')
    ...
    if st.button('Loan Test Result'):
        ...
        if (loan_prediction[0] == 1):
          prediction = 'The loan is not accepted'
        else:
          prediction = 'The loan is accepted'
